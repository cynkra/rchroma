...
An R client for ChromaDB, a modern vector database for storing and querying embeddings.
...
First, make sure you have a ChromaDB server running. Then you can connect to it:
