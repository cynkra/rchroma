...
For other installation methods and configuration options, please refer to the [ChromaDB documentation](https://docs.trychroma.com/usage-guide#running-chroma-in-clientserver-mode).
